...
class WP_Dashicons_Admin_Menu {
	private $html_before_menu = <<< HTML
...
HTML;
	...
	/**
	 * Stop output buffer, and display everything up to the menu.
	 */
	function stop_buffer(){
		$html = ob_get_clean();

		$html = explode( '<div id="wpwrap">', $html, 2 );
		echo $html[0] . '<div id="wpwrap">';
	}
	...
	function menu(){
		...
		echo $this->html_before_menu;
		$this->_wp_menu_output( $menu, $submenu );
	}
